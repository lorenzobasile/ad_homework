...
typedef struct {
    ...
    total_order_type leq; // this is the heap total order (pointer to function total_order_type defined in total_orders.h)
    void *max_order_value; // this is the maximum value of the order stored in the heap
} binheap_type;
